...
namespace WebApp2._5.Controllers
{
    public class LabsController : Controller
    {
        ...
        public LabsController(ApplicationContextViewModel context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Address")] LabsViewModel lab)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Address")] LabsViewModel lab)
        {
